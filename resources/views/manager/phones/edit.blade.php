...
@section('title', 'Редактировать телефон')

@section('content')
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2"><i class="fas fa-edit"></i> Редактировать телефон</h1>
...
<div class="card">
    <div class="card-body">
        <form method="POST" action="{{ route('manager.phones.update', $phone) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" 
                               id="name" name="name" value="{{ old('name', $phone->name) }}" required>
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" 
                                  id="description" name="description" rows="4">{{ old('description', $phone->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('price') is-invalid @enderror" 
                                   id="price" name="price" value="{{ old('price', $phone->price) }}" min="0" step="0.01" required>
                            @error('price')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('stock') is-invalid @enderror" 
                                   id="stock" name="stock" value="{{ old('stock', $phone->stock) }}" min="0" required>
                            @error('stock')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="screen_size" name="screen_size" 
                                   value="{{ old('screen_size', $phone->screen_size) }}" placeholder="6.1&quot;">
                        </div>
                        
                        <div class="col-md-6 mb-3">
                            <label for="ram" class="form-label">ОЗУ</label>
                            <input type="text" class="form-control" id="ram" name="ram" 
                                   value="{{ old('ram', $phone->ram) }}" placeholder="8 ГБ">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="battery" name="battery" 
                                   value="{{ old('battery', $phone->battery) }}" placeholder="4000 mAh">
                        </div>
                        
                        <div class="col-md-6 mb-3">
                            <label for="processor" class="form-label">Процессор</label>
                            <input type="text" class="form-control" id="processor" name="processor" 
                                   value="{{ old('processor', $phone->processor) }}" placeholder="Snapdragon 888">
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        @if($phone->image)
                            <div class="mb-2">
                                <img src="{{ $phone->image }}" class="img-thumbnail" style="max-height: 150px;">
            ...
            <div class="mb-4">
                ...
                <div id="specifications-container">
                    @php
                        $specCount = 0;
                        $specifications = old('specifications', $phone->specifications ?? []);
                    @endphp
                    ...
                    @if(!empty($specifications))
                        @foreach($specifications as $key => $spec)
                            <div class="specification-item mb-3">
                                <div class="row">
                                    <div class="col-md-5">
                                        <input type="text" class="form-control" name="specifications[{{ $key }}][name]" 
                                               placeholder="Название характеристики" value="{{ $spec['name'] }}" required>
                                    </div>
                                    <div class="col-md-5">
                                        <input type="text" class="form-control" name="specifications[{{ $key }}][value]" 
                                               placeholder="Значение" value="{{ $spec['value'] }}" required>
                                    </div>
                                    <div class="col-md-2">
